...
// WithName adds the name to the get apps params
func (o *GetAppsParams) WithName(name *string) *GetAppsParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the get apps params
func (o *GetAppsParams) SetName(name *string) {
	o.Name = name
}
